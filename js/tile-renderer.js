...
function placeGroup(initialHeights, cards, preset, existingRects = []) {
  let beam = [{ heights: [...initialHeights], placements: [], groupRects: [...existingRects], groupDistanceCost: 0, readingOrderCost: 0 }];
