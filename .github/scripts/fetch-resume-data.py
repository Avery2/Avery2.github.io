    ...
    try:
        ...
        for idx, exp in enumerate(experience):
            ...
            tile = {
                ...
                'url': f'./writing/experience/{slug}.html?path=resume~{slug}&open=last',
        ...
        for idx, edu in enumerate(education):
            ...
            tile = {
                ...
                'url': f'./writing/education/{slug}.html?path=resume~{slug}&open=last',
        ...
        # Detail pages are authored as Markdown and compiled by Avery2/writing.
        # This repository only extracts the metadata used by portfolio tiles.
...
def _legacy_generate_detail_pages(experience: List[Dict], education: List[Dict], repo_root: str):
    """Deprecated reference; detail routes are now generated by Avery2/writing."""
    try:
