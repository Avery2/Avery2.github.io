...
- This repository owns generated resume-page sources under `/writing/experience/` and `/writing/education/`; the writing Pages workflow copies them into its artifact for backward-compatible URLs.
