// Generated by generate-pages.mjs from content/*.md. Do not edit directly.
export const notes = [
  {
    "slug": "notes",
    "title": "Notes",
  ...
  },
  {
    ...
    "kind": "short",
    "ai_generated": true,
    "body": "<p>Data visualization turns values and relationships into marks that can be compared perceptually. Position and length usually support precise comparison; [[color|color]] can group or emphasize; annotation directs [[attention|attention]] toward an interpretation.</p>\n<p>The chart is not the data made neutral. Every encoding creates a [[visual-hierarchy|visual hierarchy]] and makes some questions easier than others. Responsible visualization makes those choices inspectable.</p>"
  },
  {
  ...
  },
  {
    ...
    "kind": "partial",
    "ai_generated": true,
    "body": "<p>Visual focus and keyboard focus are different systems that should tell a compatible story. When a new note opens, its heading should receive programmatic focus without throwing the reader into an arbitrary control.</p>\n<p>Visible focus, sensible source order, and [[attention|attention]] belong to the same design conversation.</p>"
  },
  {
    "slug": "history",
    "title": "History",
  ...
  },
  {
    ...
    "kind": "partial",
    "ai_generated": true,
    "body": "<p>A landmark is useful because it is distinct, stable, and encountered in relation to a route. In interfaces, titles, persistent panes, and characteristic page shapes can all become landmarks.</p>\n<p>Landmarks support [[wayfinding|wayfinding]] through recognition and help seed [[spatial-memory|spatial memory]].</p>"
  },
  {
    "slug": "legibility",
    "title": "Legibility",
  ...
  },
  {
    ...
    "kind": "partial",
    "ai_generated": true,
    "body": "<p>A short transition can show that a new surface emerged from a link and pushed older context aside. The motion carries causal information.</p>\n<p>It should remain optional. Under reduced-motion preferences, position and semantics must still explain [[interface-navigation|navigation]].</p>"
  },
  {
    "slug": "navigation",
    "title": "Navigation",
  ...
  {
    "slug": "personal-knowledge-gardens",
    "title": "Personal knowledge gardens",
    "summary": "Private / still developing.",
    "status": "private",
    "kind": "unavailable",
    "ai_generated": true,
  ...
  },
  {
    ...
    "kind": "partial",
    "ai_generated": true,
    "body": "<p>Progressive disclosure delays detail until it becomes relevant. A compressed history pane applies the same principle spatially: the object remains present, but its representation becomes simpler with distance.</p>\n<p>This is a form of semantic zoom connected to [[attention|attention]] and [[spatial-interfaces|spatial interfaces]].</p>"
  },
  {
    "slug": "reading",
    "title": "Reading",
  ...
  },
  {
    ...
    "kind": "partial",
    "ai_generated": true,
    "body": "<p>Semantic zoom does not merely make an object smaller. It chooses a representation appropriate to the available space: prose becomes a title, a title becomes a labeled edge.</p>\n<p>Continuity matters. The reader should perceive compression, not replacement. See [[progressive-disclosure|progressive disclosure]] and [[history|history]].</p>"
  },
  {
